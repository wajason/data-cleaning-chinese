...
filename= "C:/Users/User/Downloads/國家教育研究院學生學習成就資料釋出資料/國家教育研究院學生學習成就資料釋出資料/臺灣學生學習成就評量資料/2009/國語文選擇題試題作答反應/小四/2009_小四_國語文_原始資料檔.XLS"
...
# book = pd.read_excel('./../file/test.xlsx')
reference_table =pd.read_excel('C:/Users/User/Downloads/國家教育研究院學生學習成就資料釋出資料/國家教育研究院學生學習成就資料釋出資料/臺灣學生學習成就評量資料/2009/國語文選擇題試題作答反應/小四/2009_小四_國語文_試題區塊對照表(改).xls',sheet_name='04試題區塊對照表')
...
test_group_table = pd.read_excel("C:/Users/User/Downloads/國家教育研究院學生學習成就資料釋出資料/國家教育研究院學生學習成就資料釋出資料/臺灣學生學習成就評量資料/2009/國語文選擇題試題作答反應/小四/2009_小四_國語文_試題指標與區塊對照(整).xlsx")
...
stu_test = stu_c_data.groupby(['學生代號','題本號'],as_index=False)['ch結果'].sum()
...
for i in range(0,len(stu_test)):
    score_rate = round((stu_test['ch結果'][i]/test_length)*100,2)
    score_rate_list.append(score_rate)

# 新增欄位
stu_test['ch題本答對率'] = score_rate_list
...
stu_class_group = stu_c_data.groupby(['學生代號','題本號','大指標'],as_index=False)['ch結果'].sum()
...
stu_test.to_csv('C:/Users/User/Downloads/國家教育研究院學生學習成就資料釋出資料/國家教育研究院學生學習成就資料釋出資料/臺灣學生學習成就評量資料/2009/國語文選擇題試題作答反應/小四/data1.csv',encoding='utf-8-sig'  )
